...
void FXMarketTime::forex_market_time_setup() {
    ...
    string date = fx_utilities.get_todays_date();
    int day_of_week = now_local->tm_wday;

    chrono::zoned_time local_time = std::chrono::zoned_time{std::chrono::current_zone(), std::chrono::system_clock::now()};
    chrono::zoned_time london_time = std::chrono::zoned_time{"Europe/London", std::chrono::system_clock::now()};
    // --------
    ...
    vector<string> holidays = {"2024_01_01","2024_01_15","2024_02_19","2024_03_29","2024_05_27","2024_06_19","2024_07_04","2024_09_02","2024_11_28","2024_11_29","2024_12_24","2024_12_25"};
    vector<int> days_of_week_to_trade = {6, 0, 1, 2, 3, 4};
