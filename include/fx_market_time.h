...
class FXMarketTime
{
  ...
  public:
    ...
    [[nodiscard]] std::size_t seconds_till_market_is_open(int start_days_adjustment, int end_days_adjustment);
  ...
  private:
    ...
    void wait_till_trading_day(int& start_days_adjustment, int& end_days_adjustment);
